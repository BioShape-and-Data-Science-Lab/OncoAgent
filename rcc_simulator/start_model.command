...
REPAST_SIMPHONY_ROOT=$PWD/repast.simphony/repast.simphony.runtime_2.8.0
...
CP=$CP:$PWD/groovylib/org.codehaus.groovy_2.4.20.v202009301404-e2006-RELEASE/lib/groovy-all-2.4.20.jar

# Change to the Default Repast Simphony Directory
cd RenalCellCarcinoma

# Start the Model
java -XX:+IgnoreUnrecognizedVMOptions --add-modules=ALL-SYSTEM --add-exports=java.base/jdk.internal.ref=ALL-UNNAMED -cp $CP repast.simphony.runtime.RepastMain  ./RenalCellCarcinoma.rs
